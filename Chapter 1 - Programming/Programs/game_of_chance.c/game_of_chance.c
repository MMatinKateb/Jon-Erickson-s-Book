...
// It expects a message to display, pointer to the cards array.
...
// This function contains a loop to allow the game to be
...
int find_the_ace() {
    ...
    while (invalid_choice) {    // Loop until a valid choice is made.
        ...
        if (choice_two == 'c') {    // Change pick.
            i = invalid_choice = 0; // This is valid choice.
